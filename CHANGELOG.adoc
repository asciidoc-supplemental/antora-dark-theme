...
* *Documentation:* All npm install/migration detail moved to `docs/modules/guide/pages/npm-deprecation.adoc` (lessons learned + archive); other pages link there instead of duplicating npm instructions.
